...
class ShopBookmarkAdapter : RecyclerView.Adapter<ShopBookmarkAdapter.ShopViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShopBookmarkAdapter.ShopViewHolder {
    ...
    override fun onBindViewHolder(holder: ShopBookmarkAdapter.ShopViewHolder, position: Int) {
